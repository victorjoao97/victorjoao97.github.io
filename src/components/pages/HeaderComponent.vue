          ...
          <div class="text-center text-xxl-start">
            <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
              <div class="text-uppercase">
                Desenvolvimento &middot; DevOps &middot; Infraestrutura
              </div>
            </div>
            <div class="fs-3 fw-light text-muted">Eu posso ajudar seu projeto a</div>
            <h1 class="display-3 fw-bolder mb-5">
              <span class="text-gradient d-inline">Ficar online e crescer rapidamente</span>
            </h1>
            <div
              class="d-grid gap-3 d-sm-flex justify-content-sm-center justify-content-xxl-start mb-3"
            >
              <RouterLink to="/resume" custom v-slot="{ href, navigate }">
                <a
